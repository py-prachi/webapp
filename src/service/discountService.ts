...
export const update = async (
  ...
  endDate:Date) => {
    ...
    try {
        ...
        const discountRepository = AppDataSource.getRepository(Discount)
        const discount_to_update = await discountRepository.findOne({ where: { discount_id: discountId } });
    ...
    export const apply = async (
        ...
        endDate:Date
          ...
          try {
            const productDiscount = await productDiscountRepository.save(newProductDiscount);
